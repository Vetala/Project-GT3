...
void InputManager::Vibrate(int playerNumber)
{		
	_controllers[playerNumber]->Vibrate(65535, 0);
}

void InputManager::StopVibrate(int playerNumber)
{
	_controllers[playerNumber]->Vibrate(0, 0);
}